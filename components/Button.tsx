...
export const Button: React.FC<ButtonProps> = ({
  ...
  const baseStyles = "inline-flex items-center justify-center transition-colors duration-200 uppercase tracking-widest font-sans text-xs font-bold disabled:opacity-50 disabled:cursor-not-allowed";
