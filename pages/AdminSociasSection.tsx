...
import { Search, RefreshCw, Users, ArrowRight, ChevronLeft, ChevronRight, Plus, Download } from 'lucide-react';
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              {displayedMembers.map((m, i) => {
                ...
                return (
                  <tr key={m.id}
                    className={`border-b border-velum-50 hover:bg-velum-50/60 transition cursor-pointer ${i === displayedMembers.length - 1 ? 'border-b-0' : ''}`}
