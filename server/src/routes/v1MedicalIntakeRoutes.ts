...
import { getMyMedicalIntake, updateMyMedicalIntake, approveMedicalIntake, getMedicalIntakeByUserId } from "../controllers/v1MedicalIntakeController";
...
v1MedicalIntakeRoutes.get(
  "/api/v1/medical-intakes/:userId",
  requireAuth,
